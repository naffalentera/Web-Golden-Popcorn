...
const Drama = () => {
  ...
  const filteredData = dataDummy
    .filter((item) => {
      return item.drama.toLowerCase().includes(search.toLowerCase());
    })
          ...
          <table className="table">
            ...
            <tbody>
              ...
              {filteredData.map((item, index) => (
                <tr key={index} style={{ backgroundColor: "#FFEFEF" }}>
                  <td style={{ backgroundColor: "#FFEFEF" }}>{item.drama}</td>
                  ...
                  <td style={{ backgroundColor: "#FFEFEF" }}>{item.status}</td>
                  <td style={{ backgroundColor: "#FFEFEF" }}>
                    <a
                      href="#"
                      className="mx-2"
