...
const Filter = ({ onFilterChange }) => {
    ...
    useEffect(() => {
        // Reset filter ke "all" ketika query berubah
        setSelectedYear('all');
        setSelectedGenre('all');
        setSelectedCountry('all');
        setSelectedAward('all');
    }, [query]);  // Trigger ketika query berubah
    ...
    const submitFilters = (e) => {
        ...
        console.log('Filters to be applied:', filters);  // Log the filter values
        
        if (onFilterChange) {
            onFilterChange(filters);  // Panggil onFilterChange untuk meneruskan filter ke parent (SearchPage)
        } else {
